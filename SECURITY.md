...
Replace this section with the supported versions for `lockfilelens`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `lockfilelens` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in lockfilelens.
